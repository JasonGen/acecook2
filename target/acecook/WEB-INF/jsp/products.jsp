  ...
  <div class="center_content">
    ...
    <div class="right_content">
      ...
      <div class="cart">
        ...
        <a href="#" class="view_cart"><a href="<spring:url value='/cart'/>"/><spring:message code="viewCart"/></a> </div>
      <div class="title"><span class="title_icon"><!--<img src="images/bullet3.gif" alt="" />--></span><spring:message code="aboutShop"/></div>
      <div class="about">
