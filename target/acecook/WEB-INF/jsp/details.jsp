            ...
            <div class="prod_det_box">
                ...
                <div class="box_center">
                        ...
                        <c:if test="${materiel.quantiteStock = 0}">
                            ...
                            <script>
                                $(document).ready(function () {
                                    $("qtyToChoose").disabled;
                                })
                            </script>
                        </c:if>
                        <c:otherwise>
                            <b>Reste en stock : </b> ${materiel.quantiteStock}
                        </c:otherwise>
                    ...
                    <form:form
                        ...
                        <form:input id="qtyToChoose" path="nombrePieces" type="number" max="${materiel.quantiteStock}" min="1" value="1" />
