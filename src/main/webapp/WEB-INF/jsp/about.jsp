...
<body>
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><!--  <img src="images/bullet1.gif" alt="" />--></span><spring:message code="aboutTitle"/></div>
      <div class="feat_prod_box_details">
        <p class="details"> <img src="images/about.gif" alt="" class="right" /><spring:message code="siteAbout"/> <br />
          <br />
          <spring:message code="siteAbout2"/><br />
          <br />
          <spring:message code="siteAbout3"/></p>
      </div>
      <div class="clear"></div>
    </div>
    <!--end of left content-->
